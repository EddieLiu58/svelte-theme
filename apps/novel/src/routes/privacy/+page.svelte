...
<div class="mx-auto grid max-w-full grid-cols-1 gap-y-8 px-6 md:max-w-6xl">
  <h1 class="font-bold text-3xl mt-6">隱私權條款</h1>
  <p>非常歡迎您光臨「DNM-免費看小說網站」（以下簡稱本網站），為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：</p>
  <h2 class="font-bold text-xl">一、隱私權保護政策的適用範圍</h2>
  <p>隱私權保護政策內容，包括本網站如何處理在您使用網站服務時收集到的個人識別資料。隱私權保護政策不適用於本網站以外的相關連結網站，也不適用於非本網站所委託或參與管理的人員。</p>
  <h2 class="font-bold text-xl">二、個人資料的蒐集、處理及利用方式</h2>
  ...
  <h2 class="font-bold text-xl">三、資料之保護</h2>
  <ul class="list-decimal pl-6">
  ...
  <h2 class="font-bold text-xl">四、網站對外的相關連結</h2>
  <p>本網站的網頁提供其他網站的網路連結，您也可經由本網站所提供的連結，點選進入其他網站。但該連結網站不適用本網站的隱私權保護政策，您必須參考該連結網站中的隱私權保護政策。</p>
  <h2 class="font-bold text-xl">五、與第三人共用個人資料之政策</h2>
